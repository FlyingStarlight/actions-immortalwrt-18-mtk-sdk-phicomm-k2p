...
echo 'src-git omcproxy https://github.com/riverscn/luci-app-omcproxy' >>feeds.conf.default
echo 'src-git iptvhelper https://github.com/riverscn/openwrt-iptvhelper' >>feeds.conf.default

# echo '添加omcproxy iptvhelper 软件源'
git clone -b 18.06 https://github.com/smsmail2022/luci-app-omcproxy package/luci-app-omcproxy
